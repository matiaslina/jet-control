...
public class Ingreso extends javax.swing.JDialog {
    ...
    public Ingreso(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(style.StyleApp.class).getContext().getResourceMap(Ingreso.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(style.StyleApp.class).getContext().getActionMap(Ingreso.class, this);
    ...
    if(importe.getText()!=null)
        caja.insertarIngreso(campoConcepto.getText(), Double.valueOf(campoImporte.getText()));
